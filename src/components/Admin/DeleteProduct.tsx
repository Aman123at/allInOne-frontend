...
import { deleteProduct, fetchProducts } from "../../ApiCalls/productApis";
      ...
      {showDelDialog ? (
        <div>
          <div>
            ...
            <span className="font-semibold text-lg mx-2">{prodToDel.name}</span>
              ...
              currentItems.map((prod: any, key: number) => (
                <div className="flex ">
                  <svg
                    onClick={() => {
                      setProdToDel(prod);
                      setProdToDelMain(prod);
                      setShowDelDialog(true);
                      dispatch(setDeleteModal(true));
                    }}
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-5 w-5 mx-2 text-red-500 mt-3 hover:cursor-pointer hover:scale-110"
                    viewBox="0 0 20 20"
                    fill="currentColor"
                  >
                    <path
                    ...
                    >
                      <div className="accordion-body py-4 px-5">
                        ...
                        <div className="mt-2 flex flex-wrap items-center justify-evenly">
                          ...
                          <p className="font-bold">
                            Units -{" "}
                            <span className="font-medium">{prod.units}</span>
                          </p>
                        </div>
                      </div>
                    </div>
